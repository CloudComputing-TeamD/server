...
import com.project.cloud.global.response.ErrorResponse;
import com.project.cloud.global.response.result.ExceptionResult;
...
public class ExceptionAdvice {
    ...
    public ErrorResponse<List<ExceptionResult.ParameterData>> handleValidationExceptions(MethodArgumentNotValidException e) {
        ...
        return ErrorResponse.ok(ErrorCode.PARAMETER_VALIDATION_ERROR.getErrorCode(), ErrorCode.PARAMETER_VALIDATION_ERROR.getMessage(), list);
    }
    ...
    public ErrorResponse<String> handleHttpMessageParsingExceptions(HttpMessageNotReadableException e) {
        return ErrorResponse.ok(ErrorCode.PARAMETER_GRAMMAR_ERROR.getErrorCode(), ErrorCode.PARAMETER_GRAMMAR_ERROR.getMessage(), e.getMessage());
    }
